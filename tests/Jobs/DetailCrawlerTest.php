...
class DetailCrawlerTest extends TestCase
{
    /** @test */
    public function it_can_find_an_existing_schema()
    {
        ...
        $book = (new DetailCrawler('http://www.coolbookstore.com/products/21342354/cool-book-1', [], new CoolBooks(1)))
    ...
    public function it_can_generate_an_adapter()
    {
        ...
        $adapter = (new DetailCrawler($url, [], new CoolBooks(null)))->createAdapterFromData($data);
